    ...
    <div id="editCustomerModal" style="display: none; align-items: center; justify-content: center; position: fixed; z-index: 99999; left: 0; top: 0; width: 100%; height: 100%; background-color: rgba(0,0,0,0.75); backdrop-filter: blur(4px);">
        ...
        <div style="background: #1e1e1e; border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; width: 90%; max-width: 420px; padding: 24px; position: relative; box-shadow: 0 10px 25px rgba(0,0,0,0.5);">
            ...
            <form action="{{ route('admin.customers.update') }}" method="POST">
                ...
                <!-- TAMBAHAN BARU: Kekuatan Super Admin Ganti Password Pelanggan -->
                <div style="margin-bottom: 24px;">
                    <label style="display: block; margin-bottom: 8px; color: #eab308; font-size: 13px; font-weight: 600;">Ganti Password (Opsional)</label>
                    <input type="text" name="new_password" placeholder="Kosongkan jika tidak ingin diganti" style="width: 100%; background: #121212; color: #ffffff; border: 1px solid rgba(212, 168, 67, 0.4); padding: 10px 14px; border-radius: 8px; outline: none; font-family: inherit;">
                    <span style="font-size: 11px; color: #888; display: block; margin-top: 4px;">*Jika pelanggan lupa password, ketik password baru di sini.</span>
                </div>
